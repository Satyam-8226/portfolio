                  ...
                  <div className="flex flex-wrap gap-2">
                    {technologies.map((tech, techIndex) => (
                      <motion.span
                        ...
                        className="px-3 py-1.5 rounded-full bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-400/30 text-gray-200 text-xs font-medium hover:border-blue-400/60 transition-all duration-300 cursor-default"
                      >
                        {tech}
                      </motion.span>
                    ))}
