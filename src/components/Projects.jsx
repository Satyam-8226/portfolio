        ...
        >
          ...
          <div className="flex gap-3">
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white px-4 py-2 rounded-lg font-medium text-sm text-center transition-all duration-300"
            >
              Live Demo
            </motion.a>
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="flex-1 border border-slate-600 text-slate-200 hover:border-blue-400 hover:bg-blue-400/10 px-4 py-2 rounded-lg font-medium text-sm text-center transition-all duration-300"
            >
              GitHub
            </motion.a>
          </div>
